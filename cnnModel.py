...
class Cnn_Model:
    def __init__(self, trs=None, grt=None, epics=1):
        ...
        cnn_model.summary()
        cnn_model.add(Dense(3600))
        cnn_model.add(Reshape((15, 15, 16)))
        # cnn_model.add(Conv2DTranspose(32, kernel_size=(5, 5), activation='relu'))
        # cnn_model.add(BatchNormalization())
        cnn_model.add(Conv2DTranspose(16, kernel_size=(5, 5), activation='relu'))
        cnn_model.add(BatchNormalization())
        cnn_model.add(Conv2DTranspose(8, kernel_size=(5, 5), activation='relu'))
        cnn_model.add(BatchNormalization())
        cnn_model.add(Conv2DTranspose(4, kernel_size=(5, 5), activation='relu'))
        cnn_model.add(BatchNormalization())
        cnn_model.add(Conv2DTranspose(2, kernel_size=(4, 4), activation='relu'))
        cnn_model.add(BatchNormalization())
